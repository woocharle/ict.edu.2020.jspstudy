...
<head>
	...
	<script type="text/javascript">
		function test1() {
			location.href="/0717_MVC02/Mycontroller?cmd=a";
		}
		function test2() {
			location.href="/0717_MVC02/Mycontroller?cmd=b";
		}
		function test3() {
			location.href="/0717_MVC02/Mycontroller?cmd=c";
		}
		
		function send_go1(f) {
			f.action="/0717_MVC02/Mycontroller?cmd=a"
			f.submit();
		}
		function send_go2(f) {
			f.action="/0717_MVC02/Mycontroller?cmd=b"
			f.submit();
		}
		function send_go3(f) {
			f.action="/0717_MVC02/Mycontroller?cmd=c"
			f.submit();
		}
